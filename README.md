...
- **Админ** *(видна только админам)* — модерация анкет знакомств, заявки на
  публикацию офферов, список всех офферов с удалением, управление
  пользователями (право на офферы, назначение/снятие админки).
